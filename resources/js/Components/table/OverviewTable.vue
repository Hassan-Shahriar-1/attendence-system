	...
	<div class="mt-[40px]" :class="headerTopClass">
		...
		<div :class="{'overflow-x-auto': enableHorizontalScroll}">
			<table class="data-table" :class="tableScrollMinWidth">
				<thead>
					<tr>
						<div class="flex items-center w-full h-[60px] ps-4 py-5 bg-primary-hover border-b border-[#e8e8e7] rounded-tl-3xl rounded-br-3xl" :class="headerClass">
...
<script setup>
import OverviewTableSearch from "@/components/table/OverviewTableSearch.vue";
